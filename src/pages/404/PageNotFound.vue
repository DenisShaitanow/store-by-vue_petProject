  ...
  <div :class="$style.container">
    <div :class="$style.icon">
      <svg
        ...
        style="enable-background: new 0 0 477.065 477.065"
        xml:space="preserve"
      >
        <g>
          <path
    ...
    <p :class="$style.text">Такой страницы не существует.</p>
    <ButtonUI label="Вернуться на главную страницу" :class="$style.button" :onClick="handleClick" />
  </div>
</template>
