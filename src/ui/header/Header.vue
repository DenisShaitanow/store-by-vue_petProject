<template>
  ...
  <div v-if="isModal" :class="$style.header">
    ...
    <ButtonUI :class="$style.closeButton" label="Закрыть" @click="handleCloseButtonClick" tertiary>
  ...
  <div v-else :class="$style.header">
    <div data-cy="headerLogo" :class="$style.logoContainer" @click="handleClickLogo">
      <Logo />
    </div>

    <div :class="$style.menu">
      <router-link to="/about" :class="$style.link">О проекте</router-link>
    </div>
    ...
    <div :class="$style.toolbar">
      ...
      <template v-if="isAuth">
        <IconButton type="like" :is-liked="false" aria-label="Избранное" @click="handleFavorits" />
