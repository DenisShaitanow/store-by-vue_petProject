<template>
  ...
  <router-link v-if="isRouterLink" :to="routerProps.to" :class="linkClasses">
...
<script setup lang="ts">
  ...
  const isRouterLink = computed(() => 'to' in props && !props.external);

  const isExternalLink = computed(() => 'href' in props && props.external === true);
